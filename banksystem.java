...
public class banksystem {
	...
	public static void main(String args[]) throws IOException {
		...
		try {
			...
			String conurl = "jdbc:sqlserver://172.17.144.108;databaseName=S1941012570";
			con = DriverManager.getConnection(conurl, "S1941012570", "Iter1234#");
				...
				case 4:
					...
					switch (choice_variable_1) {
						...
						case 2:
							...
							query4 = "UPDATE Customer SET PHONE_NO=" + phone + " WHERE CUST_NO='" + id + "';";
							try{
								stmt.execute(query4);
								success4 = true;
